...
static void setServoPosition(uint16_t);
void mudadirecao(char d);
void alteravelo(uint16_t i);
...
static void setServoPosition(uint16_t angle)
{
	// Define pulse and angle limits
      ...
      if (angle < angleMin) {
	    ...
	    setPWM(htim4, TIM_CHANNEL_1, 12500, pulse);
}
